...
def mathlibProofObligation : MathlibProofObligation := {
  sourceKey := "EarthSciencePetrologyIgneousCanonicalLaneLean",
  theoremObject := "Igneous Petrology Classification and Petrogenetic Model",
  commonCoreImported := true,
  theoremSpecificDefinitionsNative := true,
  theoremSpecificBridgeNative := true,
  theoremSpecificAdmittedClosureNative := true,
  unrestrictedClassicalClosureNative := false,
  carriedGap := "Igneous Petrology endgame pilot closes over the admitted class; unrestricted classical closure remains carried"
}
